...
'''
In this example, InnerClass is defined within OuterClass. InnerClass has access to the attributes and methods of OuterClass, but the reverse is not true. InnerClass is instantiated using an instance of OuterClass.
