...
'''
In this example, pi is a class variable because it is declared within the class but outside any method. It is accessed using the class name Circle or through instances of the class circle1 and circle2.
