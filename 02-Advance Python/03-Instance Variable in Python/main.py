...
'''
In this example, name, age, and grade are instance variables of the Student class. They are accessed and modified using the self keyword within the methods of the class.
