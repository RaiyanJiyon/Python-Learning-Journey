...
- We alias the array by assigning arr1 to arr2. 
- Now both arr1 and arr2 refer to the same array object in memory.
- We modify the first element of the array through the arr2 alias by setting it to 10.
- When we print arr1, we see that the change made through arr2 is reflected in arr1. 
- This demonstrates that both arr1 and arr2 are aliases for the same array object.
