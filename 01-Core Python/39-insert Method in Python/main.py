...
The insert() method allows you to insert elements at any valid index within the list. If the specified index is beyond the end of the list, the new element will be appended to the end of the list.
