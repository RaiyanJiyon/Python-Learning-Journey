...
# Modulus Assignment (%=): Computes the modulus of the variable and the value on the right-hand side and assigns the result back to the variable.
x %= 3  # Equivalent to: x = x % 3

# Floor Division Assignment (//=): Performs floor division on the variable and the value on the right-hand side and assigns the result back to the variable.
x //= 2  # Equivalent to: x = x // 2
