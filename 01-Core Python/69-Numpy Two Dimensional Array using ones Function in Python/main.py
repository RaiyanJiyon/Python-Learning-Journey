...
We create a two-dimensional NumPy array filled with ones using the np.ones() function. The argument to this function is a tuple (rows, cols) specifying the shape of the array.
